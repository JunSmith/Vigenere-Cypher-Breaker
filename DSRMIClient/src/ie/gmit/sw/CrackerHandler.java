...
public class CrackerHandler extends HttpServlet 
{
	...
	public void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		VigenereRequestManager vrm = null;
		...
		if (taskNumber == null){
			...
			jobNumber = vrm.createRequest("SBTUPWAWGTMNZQKVMQZHIJWAZUGU", 4);
			System.out.println("Added request " + jobNumber);
